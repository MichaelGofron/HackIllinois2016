...
/* find jobs/careers on page */

exports.findJobs = function(done){
  debug('.findJobs() getting it');
  this.evaluate_now(function(){
    var links = document.getElementsByTagName('a');
    var obj = [];
    for (var i = 0; i < links.length; i++){
      if (links[i].innerHTML.indexOf('jobs') > -1 || links[i].id.indexOf('jobs') > -1){
        return links[i].innerHTML;
        obj.push(links[i].innerHTML);
      }
    }
    return obj;
  }, done);
